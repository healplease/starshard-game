...
EB_COLORS = {"RED": EB_COLOR_RED, "GREEN": EB_COLOR_GREEN, "CYAN": EB_COLOR_CYAN,
...
BOMB_PICKUP_POPUP_TEXT = f"+{BOMB_PICKUP_CHARGES} BOMB"   # "+1 BOMB" (story §V6.3); auto-tracks the delta
...
BONUS_LETTERS = {"REPAIR": "+", "FAN": "F", "RAPID": "R", "SHIELD": "S", "SCORE": "2",
                 "BOMB": "B"}
BONUS_COLORS = {
    "REPAIR": BONUS_REPAIR, "FAN": BONUS_FAN, "RAPID": BONUS_RAPID,
    "SHIELD": BONUS_SHIELD, "SCORE": BONUS_SCORE, "BOMB": BONUS_BOMB,
}
BONUS_NAMES = {                 # canonical labels (not drawn on the HUD)
    "REPAIR": "REPAIR", "FAN": "FAN", "RAPID": "RAPID",
    "SHIELD": "SHIELD", "SCORE": "SCORE ×2", "BOMB": "BOMB",
}
...
BONUS_WEIGHTS = (
    (29, "REPAIR"), (49, "FAN"), (69, "RAPID"), (81, "SHIELD"), (93, "SCORE"),
    (99, "BOMB"),
)
...
def asteroid_interval(t):    return max(22, 64 - 0.47 * t)
def enemy_interval(t):       return max(60, 130 - 0.60 * t)
def enemy_fire_interval(t):  return max(55, 95 - 0.35 * t)
def enemy_cap(t):            return min(6, 2 + int(t // 20))
def hazard_speed_bonus(t):   return min(2.0, 0.020 * t)
def large_chance(t):         return min(0.40, 0.25 + 0.0017 * t)
