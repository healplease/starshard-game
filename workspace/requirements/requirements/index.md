...
| `v19.md` | v19 | **R114–R119** (precise mode: hold SHIFT → ×0.5 move; always-on smaller **circular** player hitbox decoupled from draw; all bullets ~50% larger draw+collision; SHIFT-only red hitbox indicator; enemy hitboxes unchanged) + **AC102–AC108**; amends R3, R16–R18 | in progress |
...
- Quick rule: **R1–22→v1 · R23–35→v2 · R36–44→v5 · R45–55→v6 · R56–68→v7 · R69–75→v8 · R76–82→v10 · R83–91→v12 · R92–98→v14 · R99–105→v16 · R106–113→v18 · R114–119→v19**; **AC1–13→v1 · 14–21→v2 · 22–29→v5 · 30–38→v6 · 39–52→v7 · 53–60→v8 · 61–68→v10 · 69–77→v12 · 78–85→v14 · 86–93→v16 · 94–101→v18 · 102–108→v19**.
